...
- **ArkTS 编译错误**：Phase 1 后对照 `growingio-arkts-coding-style` skill 查约束表
- **修复完成后**：按 `verification-before-completion` skill 做完成前验证门（如有）
- **subagent 场景下卡住**：报告 BLOCKED 状态，提供调试报告，不继续猜
