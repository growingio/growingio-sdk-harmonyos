...
> 最新版本：2.8.0  
> MD5 值：6bb3d0ddb146820bb0a437de71839c80  
> 开发者：北京易数科技有限公司  
...
| ignoreField                    | number   | 0      | 可配置事件基础属性中的个人信息相关属性是否进行采集，默认采集；可选择过滤网络类型 (NetworkState)、屏幕分辨率及方向 (ScreenSize)、操作系统版本 (PlatformVersion)、设备型号 (DeviceModel) 等等事件基础属性 |
